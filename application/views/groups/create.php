                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateRequest"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewRequest"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteRequest"></td>
                      </tr>
                      <tr>
                        <td>Category</td>
