                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Requests</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createRequest" <?php 
                        if($serialize_permission) {
                          if(in_array('createRequest', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateRequest" <?php 
                        if($serialize_permission) {
                          if(in_array('updateRequest', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewRequest" <?php 
                        if($serialize_permission) {
                          if(in_array('viewRequest', $serialize_permission)) { echo "checked"; }  
                        }
                         ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteRequest" <?php 
                        if($serialize_permission) {
