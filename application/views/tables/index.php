      ...
      <form role="form" action="<?php echo base_url('tables/booking') ?>" method="post" id="bookingForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="booking_table_name" name="booking_table_name" readonly placeholder="Table name" autocomplete="off">
          </div>
...
{ 
  $.ajax({
    ...
    success:function(response) {
      ...
      $("#booking_table_name").val(response.table_name);
      $("#booking_capacity").val(response.capacity);
